...
namespace CMF
{
    ...
    public class SmoothGraphic : MonoBehaviour
    {
        ...
        void SmoothUpdate()
        {
            ...
            //transform.rotation = Quaternion.RotateTowards(transform.rotation, Quaternion.LookRotation(Vector3.ProjectOnPlane(GetComponentInParent<Rigidbody>().velocity, Vector3.up), transform.up), 5f);
        }
